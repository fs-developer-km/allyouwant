...
<div class="card">
  ...
  <form action="{{ route('login.post') }}" method="POST">
    ...
    <div class="remember">
      ...
      <a href="{{ route('password.request') }}" style="color:#16a34a">Forgot password?</a>
    </div>
    <button type="submit" class="btn">🔐 Login to Account</button>
  </form>

  <div class="divider">or</div>
  <div class="link">Don't have an account? <a href="{{ route('register') }}">Register Free</a></div>
  <div class="link" style="margin-top:10px"><a href="{{ route('home') }}">← Back to Home</a></div>
</div>
</body>
</html>
