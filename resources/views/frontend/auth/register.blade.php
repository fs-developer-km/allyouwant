...
<div class="card">
  ...
  <form action="{{ route('register.post') }}" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        ...
        <input type="text" name="phone" class="form-control" placeholder="10-digit number" value="{{ old('phone') }}" required>
      </div>
    </div>
    <div class="form-row">
      <div class="form-group">
  ...
  <div class="link" style="margin-top:8px"><a href="{{ route('home') }}">← Back to Home</a></div>
</div>
</body>
</html>
