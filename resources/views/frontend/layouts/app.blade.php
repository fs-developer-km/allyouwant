...
<title>@yield('title', 'All You Want') — Fresh Groceries</title>
    ...
    <div class="topbar-right">
      ...
      @auth
        ...
        <form action="{{ route('logout') }}" method="POST" style="display:inline">
          @csrf<button style="background:none;border:none;color:rgba(255,255,255,.85);cursor:pointer;font-size:12px;font-family:inherit">Logout</button>
        </form>
      @else
...
<nav class="navbar">
  <div class="navbar-inner">
    ...
    <!-- Logo Image -->
    <img src="{{ asset('assets/images/color code changeee.png') }}" alt="All You Want Logo" class="logo-img">
...
{{-- ===== HAR PAGE KA CONTENT YAHAN AAYEGA ===== --}}
@yield('content')
...
<footer>
  <div class="footer-inner">
    ...
    <div class="footer-bottom">
      <div class="f-copy">© {{ date('Y') }} All You Want. All rights reserved.</div>
...
<div class="mob-drawer" id="mobDrawer">
  ...
  <div class="mob-panel">
    ...
    <div class="mob-nav-section">
      ...
      <a href="{{ route('category.show', $cat->slug) }}" class="mob-nav-link">
        <span class="mob-icon">{{ $icons[$cat->name] ?? '🛒' }}</span> {{ $cat->name }}
...
<div class="mob-bottom-nav">
  <div class="mob-bottom-nav-inner">
    ...
    <a href="{{ route('cart.index') }}" class="mob-nav-item">
