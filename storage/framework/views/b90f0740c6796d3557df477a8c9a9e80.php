<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>Invoice #<?php echo e($order->order_number); ?></title>
<style>
...
<div class="no-print" style="margin-bottom:20px;text-align:right">
  ...
  <a href="<?php echo e(route('admin.orders.show',$order->id)); ?>" style="margin-left:10px;color:#64748b">← Back</a>
</div>
...
<div class="header">
  ...
  <div style="text-align:right"><div class="inv-title">INVOICE</div><div class="inv-num">#<?php echo e($order->order_number); ?></div><div style="font-size:12px;color:#64748b;margin-top:4px"><?php echo e($order->created_at->format('d M Y')); ?></div></div>
</div>

<div class="info-grid" style="margin-bottom:24px">
  <div>
    <div class="section-title">Bill To</div>
    <div style="font-weight:600"><?php echo e($order->delivery_name); ?></div>
    <div style="color:#64748b"><?php echo e($order->delivery_phone); ?></div>
    <div style="color:#64748b;margin-top:4px"><?php echo e($order->delivery_address); ?>, <?php echo e($order->delivery_city); ?>, <?php echo e($order->delivery_state); ?> - <?php echo e($order->delivery_pincode); ?></div>
  </div>
  <div>
    <div class="section-title">Payment Info</div>
    <div><strong>Method:</strong> <?php echo e(strtoupper($order->payment_method)); ?></div>
    <div><strong>Status:</strong> <?php echo e(ucfirst($order->payment_status)); ?></div>
    <div><strong>Order Status:</strong> <?php echo e($order->status_label); ?></div>
    <?php if($order->payment_id): ?><div><strong>Txn ID:</strong> <?php echo e($order->payment_id); ?></div><?php endif; ?>
  </div>
</div>
...
<div class="total-section">
  ...
  <div class="total-row"><span>Delivery Charge</span><span><?php echo e($order->delivery_charge > 0 ? '₹'.number_format($order->delivery_charge,2) : 'FREE'); ?></span></div>
  <?php if($order->discount > 0): ?><div class="total-row" style="color:#16a34a"><span>Discount</span><span>-₹<?php echo e(number_format($order->discount,2)); ?></span></div><?php endif; ?>
  <div class="grand-total"><span>TOTAL</span><span>₹<?php echo e(number_format($order->total,2)); ?></span></div>
</div>

<div class="footer">Thank you for shopping with GroceryMart! For support: hello@grocerymart.in</div>
</body></html>
<?php /**PATH C:\xampp\htdocs\grocery-mart-final\resources\views/admin/orders/invoice.blade.php ENDPATH**/ ?>