...
<div class="breadcrumb">
  <div class="bc-inner">
    ...
    <?php if($selectedCat): ?>
      ...
      <?php if($selectedCat->parent_id): ?>
        <?php $par = $categories->firstWhere('id', $selectedCat->parent_id); ?>
        <?php if($par): ?><a href="<?php echo e(route('shop')); ?>?category=<?php echo e($par->id); ?>"><?php echo e($par->name); ?></a><span>›</span><?php endif; ?>
      <?php endif; ?>
      <span style="color:#374151;font-weight:600"><?php echo e($selectedCat->name); ?></span>
    <?php else: ?>
...
<div class="subcat-strip-wrap <?php echo e($subCats->isEmpty() ? 'hidden' : ''); ?>" id="subcatStrip">
  <div class="subcat-strip-inner">
    ...
    <?php if($selectedCat): ?>
      <?php
        $parentForAll = $selectedCat->parent_id
          ...
          : $selectedCat;
      ?>
      <a href="<?php echo e(route('shop')); ?>?category=<?php echo e($parentForAll->id); ?>"
         class="subcat-all-pill <?php echo e((!$selectedCat->parent_id && !$selectedSubId) ? 'active' : ''); ?>">
        🗂️ All <?php echo e($parentForAll->name); ?>
    ...
    ?>
    <a href="<?php echo e(route('shop')); ?>?category=<?php echo e($sc->id); ?>"
       class="subcat-pill <?php echo e($isActive ? 'active' : ''); ?>">
      <div class="subcat-pill-img">
        <?php if($sc->image): ?><img src="<?php echo e(asset('storage/'.$sc->image)); ?>" alt="<?php echo e($sc->name); ?>">
        <?php else: ?><?php echo e($icons[$sc->name] ?? '🛒'); ?><?php endif; ?>
      </div>
      <?php echo e($sc->name); ?>

      <span class="subcat-pill-cnt"><?php echo e($sc->activeProducts->count()); ?></span>
    </a>
...
<div class="wrap">
  <div class="shop-layout">
    ...
    <aside class="sidebar">
      ...
      <a href="<?php echo e(route('shop')); ?>" class="sb-cat-item <?php echo e(!$selectedCatId ? 'active' : ''); ?>">
        <div class="sb-cat-img">🛒</div>
        <span class="sb-cat-name">All Products</span>
        <span class="sb-cat-cnt"><?php echo e($products->total()); ?></span>
      </a>
      ...
      <a href="<?php echo e(route('shop')); ?>?category=<?php echo e($cat->id); ?>"
         class="sb-cat-item <?php echo e($isSelected ? 'active' : ''); ?>">
        <div class="sb-cat-img">
          <?php if($cat->image): ?><img src="<?php echo e(asset('storage/'.$cat->image)); ?>" alt="<?php echo e($cat->name); ?>">
          <?php else: ?><?php echo e($catIcon); ?><?php endif; ?>
        </div>
        <span class="sb-cat-name"><?php echo e($cat->name); ?></span>
        <span class="sb-cat-cnt"><?php echo e($cat->activeProducts->count()); ?></span>
      </a>

      
      <?php if($isSelected && $hasChildren): ?>
      <div class="sb-subcat-list">
        
        <a href="<?php echo e(route('shop')); ?>?category=<?php echo e($cat->id); ?>"
           class="sb-subcat-item <?php echo e($selectedCatId == $cat->id && !($selectedCat && $selectedCat->parent_id) ? 'active' : ($selectedCat && !$selectedCat->parent_id ? 'active' : '')); ?>">
          <div class="sb-subcat-dot"></div>
          <span style="flex:1">All <?php echo e($cat->name); ?></span>
          <span class="sb-subcat-cnt"><?php echo e($cat->activeProducts->count()); ?></span>
        </a>
        <?php $__currentLoopData = $catSubCats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('shop')); ?>?category=<?php echo e($sc->id); ?>"
           class="sb-subcat-item <?php echo e($selectedCatId == $sc->id ? 'active' : ''); ?>">
          <div class="sb-subcat-img">
            <?php if($sc->image): ?><img src="<?php echo e(asset('storage/'.$sc->image)); ?>" alt="<?php echo e($sc->name); ?>">
            <?php else: ?><?php echo e($icons[$sc->name] ?? '🛒'); ?><?php endif; ?>
          </div>
          <span style="flex:1;font-size:12.5px"><?php echo e($sc->name); ?></span>
          <span class="sb-subcat-cnt"><?php echo e($sc->activeProducts->count()); ?></span>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="sb-sec">
        <form method="GET" action="<?php echo e(route('shop')); ?>" id="filterForm">
          <?php if($selectedCatId): ?><input type="hidden" name="category" value="<?php echo e($selectedCatId); ?>"><?php endif; ?>
          <?php if(request('sort')): ?><input type="hidden" name="sort" value="<?php echo e(request('sort')); ?>"><?php endif; ?>
          <?php if(request('stock')): ?><input type="hidden" name="stock" value="<?php echo e(request('stock')); ?>"><?php endif; ?>

          <div class="sb-filter">
            <div class="sb-filter-label">💰 Price Range</div>
            <div class="price-row">
              <input type="number" name="min_price" class="price-inp" placeholder="Min ₹" value="<?php echo e(request('min_price')); ?>">
              <span style="color:#9ca3af;font-size:12px">–</span>
              <input type="number" name="max_price" class="price-inp" placeholder="Max ₹" value="<?php echo e(request('max_price')); ?>">
            </div>
          ...
          <div class="sb-filter" style="padding-top:0">
            ...
            <?php $__currentLoopData = [''=> 'All Products', 'instock'=>'✅ In Stock Only', 'sale'=>'🏷️ On Sale']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="avail-item">
              <input type="radio" name="stock" value="<?php echo e($val); ?>" <?php echo e(request('stock')===$val ? 'checked':''); ?> onchange="this.form.submit()">
              <?php echo e($lbl); ?>
        ...
        <?php if(request()->hasAny(['category','min_price','max_price','stock','sort'])): ?>
          <div style="padding:0 16px 12px">
            <a href="<?php echo e(route('shop')); ?>" style="font-size:12.5px;color:var(--green);font-weight:600;text-decoration:none">✕ Clear All Filters</a>
          </div>
        <?php endif; ?>
      </div>
    </aside>
    ...
    <div>
      ...
      <div class="topbar-shop">
        <div class="results-info">
          Showing <strong><?php echo e($products->count()); ?></strong> of <strong><?php echo e($products->total()); ?></strong>
          <?php if($selectedCat): ?>
            in <strong><?php echo e($selectedCat->name); ?></strong>
          <?php endif; ?>
        </div>
      ...
      <div class="products-grid" id="productsGrid">
        ...
        <?php $pIcon = $icons[$product->category->name ?? ''] ?? '🛒'; ?>
        <div class="prod-card">
          <?php if(!$product->is_in_stock): ?><span class="prod-badge-abs badge-out">Out of Stock</span>
          <?php elseif($product->is_on_sale): ?><span class="prod-badge-abs badge-sale"><?php echo e($product->discount_percent); ?>% OFF</span>
          <?php elseif($product->is_new_arrival): ?><span class="prod-badge-abs badge-new">NEW</span>
          <?php elseif($product->is_bestseller): ?><span class="prod-badge-abs badge-hot">🔥 BEST</span><?php endif; ?>
          ...
          <a href="<?php echo e(route('product.show', $product->slug)); ?>">
            <div class="prod-img">
              ...
              <?php else: ?><?php echo e($pIcon); ?><?php endif; ?>
            </div>
          </a>
          <div class="prod-body">
        ...
        <div class="empty-state">
          ...
          <a href="<?php echo e(route('shop')); ?>" style="display:inline-block;background:var(--green);color:#fff;padding:11px 26px;border-radius:50px;font-size:14px;font-weight:600;text-decoration:none">Clear Filters</a>
        </div>
        <?php endif; ?>
      </div>
  ...
  <form method="GET" action="<?php echo e(route('shop')); ?>">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:7px;margin-bottom:18px">
      <?php $__currentLoopData = ['newest'=>'Newest','price_asc'=>'Price ↑','price_desc'=>'Price ↓','bestseller'=>'Best Sellers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button type="submit" name="sort" value="<?php echo e($val); ?>" style="padding:7px 14px;border-radius:50px;border:1.5px solid <?php echo e(request('sort')===$val ? 'var(--green)':'var(--border)'); ?>;background:<?php echo e(request('sort')===$val ? 'var(--green)':'#fff'); ?>;font-size:12.5px;font-weight:600;color:<?php echo e(request('sort')===$val ? '#fff':'#374151'); ?>;cursor:pointer;font-family:inherit"><?php echo e($lbl); ?></button>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:7px;margin-bottom:18px">
      <?php $__currentLoopData = [''=> 'All','instock'=>'✅ In Stock','sale'=>'🏷️ On Sale']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button type="submit" name="stock" value="<?php echo e($val); ?>" style="padding:7px 14px;border-radius:50px;border:1.5px solid <?php echo e(request('stock')===$val ? 'var(--green)':'var(--border)'); ?>;background:<?php echo e(request('stock')===$val ? 'var(--green)':'#fff'); ?>;font-size:12.5px;font-weight:600;color:<?php echo e(request('stock')===$val ? '#fff':'#374151'); ?>;cursor:pointer;font-family:inherit"><?php echo e($lbl); ?></button>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div style="display:flex;gap:8px;align-items:center;margin-bottom:14px">
      <input type="number" name="min_price" class="price-inp" placeholder="Min ₹" value="<?php echo e(request('min_price')); ?>" style="flex:1;width:auto">
      <span style="color:#9ca3af">–</span>
      <input type="number" name="max_price" class="price-inp" placeholder="Max ₹" value="<?php echo e(request('max_price')); ?>" style="flex:1;width:auto">
    </div>

    <div style="display:flex;gap:9px">
      <a href="<?php echo e(route('shop')); ?>" style="flex:1;padding:12px;border:1.5px solid var(--border);border-radius:9px;font-size:13.5px;font-weight:600;color:#374151;text-align:center;text-decoration:none">Clear All</a>
