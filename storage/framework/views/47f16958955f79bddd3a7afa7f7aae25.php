...
<div class="co-wrapper">
  ...
  <form action="<?php echo e(route('checkout.place')); ?>" method="POST" id="checkoutForm" novalidate>
    <?php echo csrf_field(); ?>
...
<input type="hidden" name="delivery_km" id="delivery_km_input" value="<?php echo e(session('delivery_km', 0)); ?>">
<input type="hidden" name="delivery_area" id="delivery_area_input" value="">

        <div class="card-body">

          
          <?php if(isset($addresses) && $addresses && count($addresses) > 0): ?>
          <div style="margin-bottom:6px">
            ...
            <div class="saved-addresses">
              <?php $__currentLoopData = $addresses->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="addr-card <?php echo e($loop->first ? 'selected' : ''); ?>" onclick="selectAddress(this, '<?php echo e(addslashes($addr->address)); ?>', '<?php echo e(addslashes($addr->city)); ?>', '<?php echo e(addslashes($addr->state)); ?>', '<?php echo e($addr->pincode); ?>')">
                <div class="addr-name"><?php echo e($addr->label ?? 'Address ' . $loop->iteration); ?></div>
                <div class="addr-detail"><?php echo e(Str::limit($addr->address, 60)); ?><br><?php echo e($addr->city); ?>, <?php echo e($addr->state); ?> - <?php echo e($addr->pincode); ?></div>
              </div>
          ...
          <div class="form-row-2">
            <div class="form-group">
              ...
              <input type="text" name="name" id="name" class="form-control <?php echo e($errors->has('name') ? 'error' : ''); ?>"
                     value="<?php echo e(old('name', auth()->user()->name)); ?>" placeholder="Your full name" required>
              <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="field-error" style="display:block"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <input type="tel" name="phone" id="phone" class="form-control <?php echo e($errors->has('phone') ? 'error' : ''); ?>"
                     value="<?php echo e(old('phone', auth()->user()->phone ?? '')); ?>" placeholder="10-digit mobile" required maxlength="10">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="text" name="address" id="address" class="form-control <?php echo e($errors->has('address') ? 'error' : ''); ?>"
                   value="<?php echo e(old('address')); ?>" placeholder="House no., Street name, Area, Landmark" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-row-3">
            <div class="form-group">
              ...
              <input type="text" name="city" id="city" class="form-control <?php echo e($errors->has('city') ? 'error' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <select name="state" id="state" class="form-control <?php echo e($errors->has('state') ? 'error' : ''); ?>" required>
                <option value="">Select</option>
                <?php $__currentLoopData = ['Andhra Pradesh','Arunachal Pradesh','Assam','Bihar','Chhattisgarh','Delhi','Goa','Gujarat','Haryana','Himachal Pradesh','Jammu & Kashmir','Jharkhand','Karnataka','Kerala','Madhya Pradesh','Maharashtra','Manipur','Meghalaya','Mizoram','Nagaland','Odisha','Punjab','Rajasthan','Sikkim','Tamil Nadu','Telangana','Tripura','Uttar Pradesh','Uttarakhand','West Bengal']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($st); ?>" <?php echo e(old('state') == $st ? 'selected' : ''); ?>><?php echo e($st); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <input type="text" name="pincode" id="pincode" class="form-control <?php echo e($errors->has('pincode') ? 'error' : ''); ?>"
                     value="<?php echo e(old('pincode')); ?>" placeholder="6-digit" required maxlength="6" oninput="checkPincode(this.value)">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group" style="margin-top:4px">
            ...
            <textarea name="notes" class="form-control" rows="2" placeholder="e.g. Leave at door, Call before delivery, etc." style="resize:vertical"><?php echo e(old('notes')); ?></textarea>
          </div>
    ...
    <div>
      <div class="card summary-card">
        <div class="card-header">
          ...
          <a href="<?php echo e(route('cart.index')); ?>" style="font-size:12px;color:var(--green);font-weight:700;text-decoration:none;">✏️ Edit</a>
        </div>
        <div class="summary-body">
          ...
          <div class="order-item">
            <div class="order-item-img">
              <?php if($imgUrl): ?>
                <img src="<?php echo e($imgUrl); ?>" alt="<?php echo e($p->name); ?>" onerror="this.style.display='none'">
              <?php else: ?>
                <span style="font-size:22px">🛒</span>
              <?php endif; ?>
            </div>
            <div style="flex:1;min-width:0">
              <div class="order-item-name"><?php echo e(Str::limit($p->name, 32)); ?></div>
              <div class="order-item-qty">Qty: <?php echo e($item['qty']); ?> × ₹<?php echo e(number_format($p->current_price)); ?></div>
            </div>
            <div class="order-item-price">₹<?php echo e(number_format($p->current_price * $item['qty'])); ?></div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="delivery-estimate" style="margin-top:14px">
            ...
            <div>
              ...
              <div class="de-date">By <?php echo e($deliveryDate); ?></div>
            </div>
          </div>
          ...
          <div class="sum-row">
            <span class="lbl">Subtotal (<?php echo e(count($products)); ?> items)</span>
            <span class="val">₹<?php echo e(number_format($subtotal)); ?></span>
          </div>
          <?php if($totalSaved > 0): ?>
          <div class="sum-row">
            <span class="lbl">Product Discount</span>
            <span class="val green">− ₹<?php echo e(number_format($totalSaved)); ?></span>
          </div>
          <?php endif; ?>
          <div class="sum-row">
            ...
            <?php else: ?>
              <span class="val">₹<?php echo e($delivery); ?></span>
            <?php endif; ?>
          </div>
          ...
          <div class="sum-total-row">
            <span>Total</span>
            <span class="total-amt">₹<?php echo e(number_format($total)); ?></span>
          </div>

          <?php if($totalSaved > 0 || $delivery == 0): ?>
          <div class="savings-pill">
            🎉 You save <strong>₹<?php echo e(number_format($totalSaved + ($delivery == 0 ? 40 : 0))); ?></strong> on this order!
          </div>
          <?php endif; ?>

          
          <button type="submit" class="btn-place-order" id="placeOrderBtn">
            <span class="btn-text">✅ Place Order • ₹<?php echo e(number_format($total)); ?></span>
...
<div class="mobile-order-bar">
  <div class="mob-total">
    ...
    <div class="mob-amt">₹<?php echo e(number_format($total)); ?></div>
  </div>
...
<div id="couponModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:1000;align-items:flex-end;justify-content:center" onclick="if(event.target===this)this.style.display='none'">
  <div style="background:#fff;border-radius:20px 20px 0 0;padding:24px;width:100%;max-width:480px;animation:slideUp .3s ease">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
      <?php $__currentLoopData = ['FRESH10' => '₹10 off', 'SAVE20' => '₹20 off', 'FIRST50' => '₹50 off', 'GREEN15' => '₹15 off']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div onclick="document.getElementById('couponCodeInput').value='<?php echo e($code); ?>'" style="padding:6px 12px;border:1.5px dashed var(--green);border-radius:6px;cursor:pointer;background:var(--green-light);font-size:12px;font-weight:700;color:var(--green)">
        <?php echo e($code); ?> <span style="color:var(--text-muted);font-weight:500">— <?php echo e($desc); ?></span>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
  </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\grocery-mart-final\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>