...
<div class="cart-wrapper">
  ...
  <div class="free-delivery-bar">
    <div class="fd-top">
      ...
      <?php else: ?>
        <span class="msg">Add <strong>₹<?php echo e(number_format($remaining)); ?></strong> more for FREE delivery</span>
        <span class="amount">₹499 target</span>
      <?php endif; ?>
    </div>
    <div class="fd-track">
      <div class="fd-fill" style="width: <?php echo e($percent); ?>%"></div>
    </div>
    <div class="fd-labels">
      <span>₹0</span>
      <span>₹499</span>
  ...
  <div class="page-header">
    <div class="page-title">
      My Cart
      <span class="cart-count-badge"><?php echo e(count($products)); ?> <?php echo e(Str::plural('item', count($products))); ?></span>
    </div>
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-header-title">
            🛍 Cart Items
            <span class="badge"><?php echo e(count($products)); ?></span>
          </div>
          <div style="font-size:12px; color:var(--text-muted); font-weight:600;">
            <?php echo e(count($products)); ?> <?php echo e(Str::plural('product', count($products))); ?> selected
          </div>
        </div>
        ...
        <div class="delivery-banner" style="background:linear-gradient(135deg,#fffbeb,#fef9c3);border-color:#fde68a;color:#92400e;">
          <span class="icon">⚡</span>
          <span>Add ₹<?php echo e(number_format(499 - $total)); ?> more to get <strong>FREE delivery</strong></span>
        </div>
        <?php endif; ?>
        ...
        <?php
          ...
          $lineTotal = $price * $qty;
        ?>
        <div class="cart-item" id="cart-item-<?php echo e($product->id); ?>">
...
?>
          <div class="item-img-wrap">
            <?php if($imgSrc): ?>
              <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($product->name); ?>" loading="lazy"
            ...
            <?php endif; ?>
            <?php if($discount > 0): ?>
              <span class="item-badge">-<?php echo e($discount); ?>%</span>
            <?php endif; ?>
          </div>
          ...
          <div class="item-details">
            ...
            <div class="item-meta">
              <?php if($product->category): ?>
                <span class="tag"><?php echo e($product->category->name ?? 'Grocery'); ?></span>
              <?php endif; ?>
            ...
            <div class="item-price-row">
              <span class="item-price-now">₹<?php echo e(number_format($price)); ?></span>
              <?php if($originalPrice > $price): ?>
                <span class="item-price-was">₹<?php echo e(number_format($originalPrice)); ?></span>
                <span class="item-discount-tag"><?php echo e($discount); ?>% OFF</span>
              <?php endif; ?>
            </div>
            <div class="qty-row">
              <div class="qty-control">
                <button class="qty-btn" onclick="changeQty(<?php echo e($product->id); ?>, -1)" <?php echo e($qty <= 1 ? 'disabled' : ''); ?>>−</button>
                <input type="number" class="qty-input" id="qty-<?php echo e($product->id); ?>" value="<?php echo e($qty); ?>" min="1" max="20" onchange="updateQty(<?php echo e($product->id); ?>, this.value)">
                <button class="qty-btn" onclick="changeQty(<?php echo e($product->id); ?>, 1)" <?php echo e($qty >= 20 ? 'disabled' : ''); ?>>+</button>
              </div>
              <div class="item-action-btns">
                <button class="btn-save-later" onclick="saveForLater(<?php echo e($product->id); ?>)">🔖 Save for Later</button>
                <form action="<?php echo e(route('cart.remove', $product->id)); ?>" method="POST" style="display:inline" onsubmit="handleRemove(event, <?php echo e($product->id); ?>)">
                  <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
          ...
          <div class="item-total-col">
            <div class="item-subtotal" id="subtotal-<?php echo e($product->id); ?>">₹<?php echo e(number_format($lineTotal)); ?></div>
            <?php if($qty > 1): ?>
              <div class="item-saved" style="font-size:10px;color:var(--text-muted)"><?php echo e($qty); ?> × ₹<?php echo e(number_format($price)); ?></div>
            <?php endif; ?>
            <?php if($discount > 0): ?>
              <div class="item-saved">Saved ₹<?php echo e(number_format(($originalPrice - $price) * $qty)); ?></div>
            <?php endif; ?>
          </div>
      ...
      <div class="card summary-card">
        ...
        <div class="summary-body">
          ...
          <div class="summary-row">
            <span class="label">Price (<?php echo e(count($products)); ?> items)</span>
            <span class="value">₹<?php echo e(number_format($total + $totalSaved)); ?></span>
          </div>
          <?php if($totalSaved > 0): ?>
          <div class="summary-row">
            <span class="label">Discount</span>
            <span class="value green">− ₹<?php echo e(number_format($totalSaved)); ?></span>
          </div>
          <?php endif; ?>
          <div class="summary-row">
            ...
            <?php else: ?>
              <span class="value">₹<?php echo e($delivery); ?></span>
            <?php endif; ?>
          </div>
          ...
          <div class="summary-total-row">
            ...
            <span id="grandTotalDisplay">₹<?php echo e(number_format($grandTotal)); ?></span>
          </div>

          <?php if($totalSaved > 0 || $delivery == 0): ?>
          <div class="you-save-banner">
            🎉 You are saving <strong>₹<?php echo e(number_format($totalSaved + ($delivery == 0 ? 40 : 0))); ?></strong> on this order!
          </div>
          <?php endif; ?>
          ...
          <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="btn-checkout">
              Login to Checkout <span class="arrow">→</span>
            </a>
          <?php endif; ?>

          <a href="<?php echo e(route('shop')); ?>" class="continue-shop">
            ← Continue Shopping
          </a>
  ...
  <div class="recently-viewed">
    ...
    <div class="rv-grid">
      <?php $__currentLoopData = $related->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
  $rpImg = null;
...
?>
      <a href="<?php echo e(route('product.show', $rp->slug ?? $rp->id)); ?>" class="rv-item">
        <div class="rv-img">
          <?php if($rpImg): ?>
            <img src="<?php echo e($rpImg); ?>" alt="<?php echo e($rp->name); ?>"
        ...
        <div class="rv-name"><?php echo e(Str::limit($rp->name, 28)); ?></div>
        <div class="rv-price">₹<?php echo e(number_format($rp->current_price)); ?></div>
        <form action="<?php echo e(route('cart.add', $rp->id)); ?>" method="POST" onclick="event.stopPropagation()">
          <?php echo csrf_field(); ?>
  ...
  <div class="card" style="margin-top:8px">
    <div class="empty-state">
      ...
      <a href="<?php echo e(route('shop')); ?>" class="btn-shop-now">
...
<div class="mobile-checkout-bar">
  <div class="total-info">
    ...
    <div class="total-amount">₹<?php echo e(number_format(($total >= 499) ? $total : $total + 40)); ?></div>
  </div>
  <?php if(auth()->guard()->check()): ?>
    <a href="<?php echo e(route('checkout.index')); ?>" class="btn-checkout-mobile">Checkout →</a>
  <?php else: ?>
    <a href="<?php echo e(route('login')); ?>" class="btn-checkout-mobile">Login →</a>
  <?php endif; ?>
</div>
<?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\grocery-mart-final\resources\views/frontend/cart.blade.php ENDPATH**/ ?>