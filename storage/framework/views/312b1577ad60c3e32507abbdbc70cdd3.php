    ...
    <aside class="acc-sidebar">
      ...
      <div class="acc-profile-card">
        <div class="acc-profile-top">
          <div class="acc-avatar"><?php echo e(strtoupper(substr($user->name,0,2))); ?></div>
          <div class="acc-name"><?php echo e($user->name); ?></div>
          <div class="acc-email"><?php echo e($user->email); ?></div>
          <div class="acc-member-badge">⭐ Valued Customer</div>
        </div>
        <div class="acc-profile-stats">
          <div class="aps-item"><div class="aps-num"><?php echo e($totalOrders); ?></div><div class="aps-lbl">Orders</div></div>
          <div class="aps-item"><div class="aps-num"><?php echo e($delivered); ?></div><div class="aps-lbl">Delivered</div></div>
          <div class="aps-item"><div class="aps-num">₹<?php echo e(number_format($totalSpent,0)); ?></div><div class="aps-lbl">Spent</div></div>
        </div>
      </div>
      ...
      <div class="acc-nav">
        ...
        <button class="acc-nav-item active" onclick="showPanel('orders',this)">
          ...
          <?php if($pending > 0): ?><span class="acc-nav-badge"><?php echo e($pending); ?></span><?php endif; ?>
        </button>
        ...
        <a href="<?php echo e(route('home')); ?>" class="acc-nav-item" style="text-decoration:none">
    ...
    <div class="acc-main">
      ...
      <div class="stats-row reveal">
        ...
        <div class="stat-box">
          ...
          <div>
            <div class="stat-num"><?php echo e($pending); ?></div>
        ...
        <div class="stat-box">
          ...
          <div>
            <div class="stat-num"><?php echo e($delivered); ?></div>
        ...
        <div class="stat-box">
          ...
          <div>
            <div class="stat-num">₹<?php echo e(number_format($totalSpent,0)); ?></div>
      ...
      <div class="quick-actions reveal" style="transition-delay:.05s">
        <a href="<?php echo e(route('shop')); ?>" class="qa-item">
        ...
        <a href="<?php echo e(route('offers')); ?>" class="qa-item">
          <div class="qa-icon">🔥</div>
      ...
      <div class="acc-panel active" id="panel-orders">
        ...
        <div class="sec-head">
          ...
          <a href="<?php echo e(route('shop')); ?>" style="font-size:13px;font-weight:700;color:var(--g);text-decoration:none;padding:8px 16px;border:1.5px solid var(--gl2);border-radius:50px;background:var(--gl)">+ New Order</a>
        </div>

        
        <div style="display:flex;gap:6px;margin-bottom:18px;overflow-x:auto;scrollbar-width:none;padding-bottom:2px">
          <?php $__currentLoopData = ['all'=>'All','pending'=>'Pending','processing'=>'Processing','shipped'=>'Shipped','out_for_delivery'=>'Out for Delivery','delivered'=>'Delivered','cancelled'=>'Cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <button onclick="filterOrders('<?php echo e($s); ?>')" id="otab-<?php echo e($s); ?>" style="padding:7px 16px;border-radius:50px;border:1.5px solid var(--border);background:var(--white);font-size:12.5px;font-weight:600;color:var(--text2);cursor:pointer;white-space:nowrap;transition:all .15s;font-family:inherit" class="<?php echo e($s==='all' ? 'otab-active' : ''); ?>"><?php echo e($l); ?></button>
        ...
        ?>
        <div class="order-card reveal" data-status="<?php echo e($order->status); ?>" style="transition-delay:<?php echo e($loop->index * .07); ?>s">

          
          <div class="order-card-head">
            <div>
              <div class="order-num">#<?php echo e($order->order_number); ?></div>
              <div class="order-date">📅 <?php echo e($order->created_at->format('d M Y, h:i A')); ?></div>
            </div>
            <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
              <span class="badge badge-<?php echo e($order->status); ?>">
                <?php echo e(['pending'=>'⏳','confirmed'=>'✅','processing'=>'🍱','shipped'=>'🚚','out_for_delivery'=>'🛵','delivered'=>'🎉','cancelled'=>'❌','refunded'=>'↩️'][$order->status] ?? '📦'); ?>

                <?php echo e($order->status_label); ?>

              </span>
              <a href="<?php echo e(route('order.show', $order->id)); ?>" style="font-size:12px;font-weight:700;color:var(--g);text-decoration:none;padding:5px 12px;border:1.5px solid #b7e4c7;border-radius:6px;background:var(--gl);white-space:nowrap">View Details →</a>
            </div>
          </div>
          ...
          <div class="order-items-strip">
            ...
            <div class="order-item-thumb">
              <?php if($item->product_image): ?>
                <img src="<?php echo e(asset('storage/'.$item->product_image)); ?>" alt="<?php echo e($item->product_name); ?>" onerror="this.style.display='none'">
              <?php else: ?>
                🛒
              <?php endif; ?>
            </div>
            ...
            <?php if($order->items->count() > 3): ?>
              <div class="order-more-items">+<?php echo e($order->items->count() - 3); ?> more items</div>
            <?php endif; ?>
            <div style="margin-left:auto;text-align:right">
              <div style="font-size:13px;color:var(--muted)"><?php echo e($order->items->sum('quantity')); ?> items</div>
              <div style="font-size:15px;font-weight:800;color:var(--text)">₹<?php echo e(number_format($order->total)); ?></div>
            </div>
          </div>
          ...
          <div class="order-tracker">
            ...
            <div class="tracker-steps" id="tracker-<?php echo e($order->id); ?>">
              
              <div class="tracker-line-fill" style="width:<?php echo e($lineW); ?>%"></div>
              <?php $__currentLoopData = $trackerIcons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
                $isDone   = $stepNum > $idx;
              ...
              <div class="tracker-step">
                <div class="ts-dot <?php echo e($cls); ?>"><?php echo e($isDone ? '✓' : $icon); ?></div>
                <div class="ts-label <?php echo e($cls); ?>" style="font-size:9.5px"><?php echo e($trackerLabels[$idx]); ?></div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          </div>
          ...
          <div class="order-card-foot">
            <div>
              <div class="order-total">₹<?php echo e(number_format($order->total)); ?></div>
              <div class="order-payment">
                ...
                <?php else: ?>
                  · Delivery ₹<?php echo e($order->delivery_charge); ?>
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
              ...
              <?php elseif($order->status === 'pending'): ?>
                <a href="<?php echo e(route('order.show', $order->id)); ?>" style="padding:7px 14px;border-radius:7px;border:1.5px solid #fde68a;background:#fffbeb;font-size:12.5px;font-weight:600;cursor:pointer;color:#92400e;text-decoration:none">📞 Contact Us</a>
              <?php elseif(in_array($order->status, ['cancelled','refunded'])): ?>
                <span style="font-size:12px;color:var(--muted)">Need help? Call 9911011411</span>
              <?php else: ?>
                <a href="https://wa.me/919911011411?text=Order <?php echo e($order->order_number); ?> status?" target="_blank" style="padding:7px 14px;border-radius:7px;border:1.5px solid #bbf7d0;background:var(--gl);font-size:12.5px;font-weight:600;color:var(--g2);text-decoration:none">💬 Track</a>
              <?php endif; ?>
              <div style="font-size:11px;color:var(--muted)">📍 <?php echo e($order->delivery_city); ?></div>
            </div>
          </div>
        ...
        <div class="dash-card">
          <div class="empty-state">
            ...
            <a href="<?php echo e(route('shop')); ?>" class="btn-shop">🛍️ Shop Now</a>
          </div>
        </div>
        <?php endif; ?>
      ...
      <div class="acc-panel" id="panel-profile">
        ...
        <div class="dash-card reveal">
          ...
          <div class="dash-card-body">
            <form action="<?php echo e(route('account.index')); ?>" method="POST" onsubmit="showToast('✅ Profile updated successfully!')">
              <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
              <div class="form-row-2">
                <div class="form-group">
                  <label class="form-label">Full Name</label>
                  <input type="text" class="form-control" name="name" value="<?php echo e($user->name); ?>" placeholder="Your full name">
                </div>
                <div class="form-group">
                  <label class="form-label">Phone Number</label>
                  <input type="tel" class="form-control" name="phone" value="<?php echo e($user->phone ?? ''); ?>" placeholder="10-digit mobile" maxlength="10">
                </div>
              </div>
              <div class="form-group">
                <label class="form-label">Email Address</label>
                <input type="email" class="form-control" name="email" value="<?php echo e($user->email); ?>" placeholder="your@email.com">
              </div>
          ...
          <div class="dash-card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
              <div style="background:var(--border2);border-radius:9px;padding:14px">
                ...
                <div style="font-size:14px;font-weight:700;color:var(--text)"><?php echo e($user->created_at->format('d M Y')); ?></div>
              </div>
              <div style="background:var(--border2);border-radius:9px;padding:14px">
              ...
              <div style="background:var(--border2);border-radius:9px;padding:14px">
                ...
                <div style="font-size:14px;font-weight:700;color:var(--text)"><?php echo e($totalOrders); ?> orders placed</div>
              </div>
              <div style="background:var(--border2);border-radius:9px;padding:14px">
      ...
      <div class="acc-panel" id="panel-addresses">
        ...
        <div class="dash-card reveal">
          ...
          <div class="dash-card-body">
            <div class="addr-grid">
              <?php $addresses = $user->addresses ?? collect(); ?>
              ...
              <div class="addr-card <?php echo e($addr->is_default ? 'default' : ''); ?>">
                <?php if($addr->is_default): ?><div class="addr-default-badge">Default</div><?php endif; ?>
                <div class="addr-label">
                  <?php echo e(['Home'=>'🏠','Work'=>'💼','Other'=>'📍'][$addr->label] ?? '📍'); ?> <?php echo e($addr->label ?? 'Address'); ?>
        ...
        <div class="dash-card reveal" style="transition-delay:.05s">
          ...
          <div class="dash-card-body">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:7px">
              <?php $__currentLoopData = ['Mayur Vihar Ph-1','Mayur Vihar Ph-2','Mayur Vihar Ph-3','Preet Vihar','Kondli','Patparganj','Shahdara','Laxmi Nagar','Anand Vihar','Mandawali','Geeta Colony','Gandhi Nagar','Noida Sec-1','Noida Sec-14']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <span style="background:var(--gl2);color:var(--g2);font-size:11.5px;font-weight:600;padding:4px 12px;border-radius:20px;border:1px solid #b7e4c7"><?php echo e($area); ?></span>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          </div>
        </div>
      ...
      <div class="acc-panel" id="panel-wishlist">
        ...
        <div class="dash-card reveal">
          <div class="empty-state">
            ...
            <a href="<?php echo e(route('shop')); ?>" class="btn-shop">🛍️ Explore Products</a>
          </div>
        </div>
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\grocery-mart-final\resources\views/frontend/account/dashboard.blade.php ENDPATH**/ ?>