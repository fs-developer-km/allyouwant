...
<div class="card">
  ...
  <div class="order-num">
    ...
    <div class="order-num-val">#<?php echo e($order->order_number); ?></div>
  </div>
  <div style="font-size:13px;color:#64748b;margin-bottom:24px">
    Payment: <strong><?php echo e(strtoupper($order->payment_method)); ?></strong> · Total: <strong style="color:#16a34a">₹<?php echo e(number_format($order->total)); ?></strong>
  </div>
  <a href="<?php echo e(route('home')); ?>" class="btn">🏠 Back to Home</a>
  <a href="<?php echo e(route('account.index')); ?>" class="btn btn-outline">📦 Track Order</a>
</div>
</body></html>
<?php /**PATH C:\xampp\htdocs\grocery-mart-final\resources\views\frontend\order-success.blade.php ENDPATH**/ ?>