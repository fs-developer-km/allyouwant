...
<nav class="navbar">
  ...
  <div class="nav-links"><a href="<?php echo e(route('account.index')); ?>">← My Account</a></div>
</nav>
<div class="wrap">
  ...
  <div class="card">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo e(route('order.show',$order->id)); ?>" style="color:#16a34a;font-weight:600">View</a></td>
        </tr>
    ...
    <?php else: ?>
    <div style="text-align:center;padding:40px;color:#9ca3af">No orders yet. <a href="<?php echo e(route('shop')); ?>" style="color:#16a34a">Start shopping!</a></div>
    <?php endif; ?>
  </div>
</div>
</body></html>
<?php /**PATH C:\xampp\htdocs\grocery-mart-final\resources\views/frontend/account/orders.blade.php ENDPATH**/ ?>