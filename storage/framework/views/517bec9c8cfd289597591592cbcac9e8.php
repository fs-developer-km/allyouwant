...
<nav class="navbar">
  <div class="navbar-inner">
    ...
    <a href="<?php echo e(route('cart.index')); ?>" class="mob-cart-icon">
      <svg viewBox="0 0 24 24"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
      <?php if(isset($cartCount) && $cartCount > 0): ?><span class="nav-badge"><?php echo e($cartCount); ?></span><?php endif; ?>
    </a>
...
<div class="cat-nav">
  <div class="cat-nav-inner">
    ...
    <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <a href="<?php echo e(route('category.show', $cat->slug)); ?>" class="cat-link <?php echo e($cat->id == $category->id ? 'active' : ''); ?>"><?php echo e($icon); ?> <?php echo e($cat->name); ?></a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="page-wrap" style="padding-top:4px;padding-bottom:40px">
  ...
  <div class="breadcrumb">
    ...
    <span>›</span>
    <span style="color:#1a1a2e;font-weight:500"><?php echo e($category->name); ?></span>
  </div>
  ...
  ?>
  <div class="cat-hero" style="background:<?php echo e($heroGrad); ?>">
    <div class="cat-hero-glow"></div>
    <div class="cat-hero-text">
      <div class="cat-hero-tag">📦 <?php echo e($products->total()); ?> Products Available</div>
      <div class="cat-hero-title"><?php echo e($category->name); ?></div>
      <div class="cat-hero-sub"><?php echo e($category->description ?? 'Fresh, quality products delivered to your door'); ?></div>
    </div>
    <div class="cat-hero-emoji"><?php echo e($heroIcon); ?></div>
  </div>
  ...
  <div class="filter-bar">
    <div class="filter-left">
      ...
      <form method="GET" id="sortForm">
        <select class="sort-select" name="sort" onchange="document.getElementById('sortForm').submit()">
          <option value="default" <?php echo e(request('sort','default')=='default' ? 'selected':''); ?>>Default</option>
    ...
    <div class="result-count">
      Showing <strong><?php echo e($products->firstItem()); ?>–<?php echo e($products->lastItem()); ?></strong> of <strong><?php echo e($products->total()); ?></strong> products
    </div>
  </div>
  ...
  <div class="cat-layout">
    ...
    <aside class="sidebar">
      ...
      <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $icon = $catIcons[$cat->name] ?? '🛒'; ?>
        <a href="<?php echo e(route('category.show', $cat->slug)); ?>" class="sidebar-cat-link <?php echo e($cat->id == $category->id ? 'active' : ''); ?>">
          <span><span class="sidebar-cat-icon"><?php echo e($icon); ?></span><?php echo e($cat->name); ?></span>
          <span style="font-size:11px;color:#9ca3af"><?php echo e($cat->activeProducts_count ?? ''); ?></span>
        </a>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="price-range">
        <form method="GET" id="priceForm">
          ...
          <div class="price-inputs">
            <input class="price-input" type="number" name="min_price" placeholder="Min ₹" value="<?php echo e(request('min_price')); ?>">
            <input class="price-input" type="number" name="max_price" placeholder="Max ₹" value="<?php echo e(request('max_price')); ?>">
          </div>
    ...
    <div>
      <div class="products-grid">
        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php $pIcon = $catIcons[$product->category->name ?? ''] ?? '🛒'; ?>
          <div class="prod-card">
            ...
            <div class="prod-body">
              ...
              <div class="prod-rating">
                ...
                <span class="rating-n">(<?php echo e($product->approvedReviews->count() ?? 0); ?>)</span>
              </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          <div class="empty-state">
            ...
            <div class="empty-title">No products in <?php echo e($category->name); ?> yet</div>
      ...
      <div class="pagination-wrap">
        ...
        <?php else: ?>
          <a href="<?php echo e($products->previousPageUrl()); ?>" class="page-link">‹</a>
        <?php endif; ?>
        ...
        <?php if($products->hasMorePages()): ?>
          <a href="<?php echo e($products->nextPageUrl()); ?>" class="page-link">›</a>
        <?php else: ?>
          <span class="page-link disabled">›</span>
        <?php endif; ?>
      </div>
...
<div class="mob-drawer" id="mobDrawer">
  ...
  <div class="mob-panel">
    ...
    <div style="display:flex;gap:10px;padding:16px 18px">
      <?php if(auth()->guard()->check()): ?>
        <a href="<?php echo e(route('account.index')); ?>" style="flex:1;padding:11px;border:1.5px solid #0d6e39;border-radius:8px;font-size:13.5px;font-weight:600;color:#0d6e39;text-align:center;text-decoration:none">My Account</a>
      <?php else: ?>
        <a href="<?php echo e(route('login')); ?>" style="flex:1;padding:11px;border:1.5px solid #0d6e39;border-radius:8px;font-size:13.5px;font-weight:600;color:#0d6e39;text-align:center;text-decoration:none">Login</a>
        <a href="<?php echo e(route('register')); ?>" style="flex:1;padding:11px;background:#0d6e39;border:none;border-radius:8px;font-size:13.5px;font-weight:600;color:#fff;text-align:center;text-decoration:none">Register</a>
      <?php endif; ?>
    </div>
    <div>
      ...
      <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a href="<?php echo e(route('category.show', $cat->slug)); ?>" class="mob-nav-link <?php echo e($cat->id==$category->id ? 'active':''); ?>" style="<?php echo e($cat->id==$category->id ? 'background:#f0faf4;color:#0d6e39;font-weight:600':''); ?>">
          <?php echo e($icons[$cat->name] ?? '🛒'); ?> <?php echo e($cat->name); ?>
...
<div class="mob-bottom-nav">
  <div class="mob-bottom-nav-inner">
    ...
    <a href="<?php echo e(route('offers')); ?>" class="mob-nav-item"><svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>Offers</a>
